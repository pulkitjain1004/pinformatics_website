...
<html lang="en"><head>
  ...
  <body>
    ...
    <div class="container">
        ...
        <p>Please enter the password in the dialogue box.</p>
        ...
        <script type="text/javascript">
			...
			while (s!= "mypassword")
			{
				...
				if (s=="mypassword")
				{
					window.location.href="internal_protected_madcr36pic9e9pz8w6mz.php"; //page to redirect if password entered is correct
				}
				else
				{
